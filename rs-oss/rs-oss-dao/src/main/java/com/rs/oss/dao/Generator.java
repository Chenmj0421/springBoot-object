...
public class Generator {
	...
	// 根据命名规范，只修改此常量值即可
	private static String MODULE = "rs-oss";
	private static String DATABASE = "rs-oss";
	private static String TABLE_PREFIX = "oss_";
	private static String PROJECT_NAME = "Oss";
	private static String PACKAGE_NAME = "com.rs.oss";
