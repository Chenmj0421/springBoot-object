...
public class Generator {
	...
	/** 根据命名规范，只修改此常量值即可*/
	/** 系统名称*/
	private static String MODULE = "rs-visit";
	/** 数据库名称*/
	private static String DATABASE = "rs";
	/** 表开头*/
	private static String TABLE_PREFIX = "visit_";
	/** 系统名称 第一个字母大写*/
	private static String PROJECT_NAME = "Visit";
	/** 包名*/
	private static String PACKAGE_NAME = "com.rs.visit";
